...
| `05-desktop-i3` | `desktop.apt`, Brave + VS Code vendor repos, imports i3 config/i3blocks/fonts/terminator, i3blocks-contrib, VMware RDP xmodmap fixes. Makes **lightdm** the display manager via debconf and **i3 the default session**, then asserts both landed (see above) |
